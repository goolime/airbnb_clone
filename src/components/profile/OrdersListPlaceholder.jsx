    ...
    export function OrdersListPlaceholder() {
        ...
        return (
            <>
                <div className="flex flex-row items-center align-center mx-auto gap-4 mb-4 w-[100%]">
                        ...
                        <div className="relative w-[100%] border mx-auto border-gray-300 rounded-xl grid py-2 px-3 grid-cols-2 ">
                            <button className={`p-[1rem] h-[2.5rem] text-gray-700 text-center text-[1em] bg-gray-300 font-semibold scale-97 rounded-xl z-10;`} />
                            <button className={`p-[1rem] h-[2.5rem] text-gray-700 text-center text-[1em] bg-gray-300 font-semibold scale-97 rounded-xl z-10;`} />
                        </div>
                    </div>
                ...
                <div className="flex flex-row md:flex-col  gap-4 h-[70vh] overflow-hidden  max-md:snap-x md:snap-y snap-mandatory ">
