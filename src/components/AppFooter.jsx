export function AppFooter() {
    ...
    return <>
        ...
        <footer className="flex flex-col bg-(--headerBg) ">
            <div className="grid grid-cols-wrap sm:grid-cols-[5px_repeat(6,1fr)_5px] lg:grid-cols-[5px_repeat(12,1fr)_5px] gap-8 px-6 sm:px-0 sm:border-b sm:border-gray-200 py-12">
