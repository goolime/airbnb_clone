...
export function AddProperty( {styles}) {
    ...
    return <>
        <div className="relative add-property-hover" onClick={()=>showPropertyCreation()}>
            <div className="z-10 absolute text-gray-100 top-1/2 left-1/2 bg-gray-400 p-4 rounded-full cursor-pointer -translate-x-1/2 -translate-y-1/2 transition-all add-property-icon" >
                <Plus />
            </div>
