...
import { DayPicker, getDefaultClassNames, NextMonthButton } from "react-day-picker"
...
export function DatePicker() {
    ...
    return <>
        <div className="flex justify-center">
            ...
            navLayout="around"
            fixedWeeks={true}
            disabled={{ before: now, after: new Date(now.getFullYear() + 1, now.getMonth(), now.getDate()) }}
